...
d.deleteTemplateUrl&&(n=d.deleteTemplateUrl);var k=f.open({scope:a,templateUrl:n,windowClass:"adf-remove-widget-modal",backdrop:"static"});a.closeDialog=function(){k.close();a.$destroy()};a.deleteDialog=function(){g();a.closeDialog()}}else g()};c.reload=function(){c.$broadcast("widgetReload")};c.edit=function(){function g(a){if("boolean"===typeof a){var c=h.defer();a?c.resolve():c.reject();a=c.promise}else a=h.when(a);return a}var n=c.$new();n.translate=b.translate;n.definition=angular.copy(d);var k=
e+"widget-edit.html";d.editTemplateUrl&&(k=d.editTemplateUrl);var u=f.open({scope:n,templateUrl:k,windowClass:"adf-edit-widget-modal",backdrop:"static"});n.closeDialog=function(){u.close();n.$destroy()};n.saveDialog=function(){n.validationError=null;var b=c.widget,k;k=b.edit?b.edit.apply:function(){return!0};k=a.invoke(k,k,{widget:b,definition:n.definition,config:n.definition.config});g(k).then(function(){d.title=n.definition.title;angular.extend(d.config,n.definition.config);b.edit&&b.edit.reload&&
c.$broadcast("widgetConfigChanged");n.closeDialog()},function(a){n.validationError=a?a:"Validation durring apply failed"})}}}else m.debug("widget not found")}function t(a){a.$on("adfDashboardCollapseExpand",function(b,c){a.widgetState.isCollapsed=c.collapseExpandStatus});a.$on("adfWidgetEnterEditMode",function(c,d){b.idEquals(a.definition.wid,d.wid)&&a.edit()});a.widgetClasses=function(b,c){c=c.styleClass||"";b&&b.frameless&&!a.editMode||(c+=" panel panel-default");return c};a.openFullScreen=function(){var b=
a.definition,c=a.$new(),g=f.open({scope:c,templateUrl:e+"widget-fullscreen.html",size:b.modalSize||"lg",backdrop:"static",windowClass:b.fullScreen?"dashboard-modal widget-fullscreen":"dashboard-modal"});c.closeDialog=function(){g.close();c.$destroy()}}}t.$inject=["$scope"];return{replace:!0,restrict:"EA",transclude:!1,templateUrl:b.customWidgetTemplatePath?b.customWidgetTemplatePath:e+"widget.html",scope:{adfModel:"=",definition:"=",col:"=column",editMode:"=",options:"=",widgetState:"="},controller:t,
compile:function(){return{pre:p,post:l}}}}]);angular.module("adf").directive("adfWidgetContent",["$log","$q","widgetService","$compile","$controller","$injector","dashboard",function(a,h,m,f,q,b,e){function p(b,k){a.warn(k);b.html(e.messageTemplate.replace(/{}/g,k))}function l(a,b,d){var c=a.model,r=a.content,n=d;c?r?n=t(a,b,d,c,r):p(b,"widget content is undefined, please have a look at your browser log"):p(b,"model is undefined");return n}function t(a,k,d,g,r){k.html(e.loadingTemplate);var c=a.$new();
g.config||(g.config={});c.config=g.config;var l={$scope:c,widget:g,config:g.config},u={};u.$tpl=m.getTemplate(r);r.resolve&&angular.forEach(r.resolve,function(a,c){angular.isString(a)?u[c]=b.get(a):u[c]=b.invoke(a,a,l)});h.all(u).then(function(a){angular.extend(a,l);r.resolveAs&&(c[r.resolveAs]=a);k.html(a.$tpl);r.controller&&(a=q(r.controller,a),r.controllerAs&&(c[r.controllerAs]=a),k.children().data("$ngControllerController",a));f(k.contents())(c)},function(a){var b="Could not resolve all promises";
