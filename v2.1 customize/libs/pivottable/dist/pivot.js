  ...
  callWithJQuery(function($) {
    ...
    aggregators = (function(tpl) {
      ...
      //  "List Unique Values": tpl.listUnique(", "),
        "Cộng": tpl.sum(usFmt),
        "Cộng số nguyên": tpl.sum(usFmtInt),
        "Tính trung bình": tpl.average(usFmt),
        "Đếm": tpl.count(usFmtInt),
    ...
    locales = {
      en: {
        ...
        localeStrings: {
          ...
          selectNone: "Chọn None",
          tooMany: "(too many to list)",
          filterResults: "Giá trị lọc",
          apply: "Áp dụng",
          cancel: "Huỷ",
          totals: "Cộng",
          vs: "vs",
