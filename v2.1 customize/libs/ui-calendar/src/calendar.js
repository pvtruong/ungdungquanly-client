            ...
            return {
                ...
                link : function (scope, elm, attrs, controller) {
                    ...
                    function getOptions () {
                        ...
                        options = {
                            eventSources : scope.eventSources//sources
                        };
                    ...
                    scope.initCalendar = function () {
                        ...
                        if (attrs.calendar) {
                         ...
                         var el = document.querySelector(".fc-center");
                        var headerTitle = angular.element(el);
                        headerTitle.bind('click',function(){
                            alert("choose year and month");
                        });
                    };
                    ...
                    scope.$watch("zevents", function (newValue, oldValue) {
                        if (newValue !== oldValue) {
                            scope.destroyCalendar();
                            scope.initCalendar();
                        }
