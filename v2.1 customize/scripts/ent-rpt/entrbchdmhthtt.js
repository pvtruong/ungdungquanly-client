var entrbchdmhthtt = new baseRptLink('entrbchdmhthtt','rbchdmhthtt/1','ENT-Hóa đơn mua hàng theo hạn thanh toán',{
...
entrbchdmhthtt.defaultCondition = function(condition){
	var c = new Date();
