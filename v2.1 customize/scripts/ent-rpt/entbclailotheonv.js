var entbclailotheonv = new baseRptLink('entbclailotheonv','rbcbhtheodoanhso/1','ENT-Báo cáo bán hàng theo số lượng và doanh số',{
	onLoading:function($scope,options){
        ...
        $scope.series = [ 'Doanh thu','Số lượng'];
	},
...
entbclailotheonv.defaultCondition = function(condition){
	var c = new Date();
