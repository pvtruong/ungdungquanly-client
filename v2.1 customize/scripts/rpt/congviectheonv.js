var rptcongviectheonv = new baseRpt('congviectheonv','congviectheonv','Đánh giá công việc theo nhân viên',{
...
rptcongviectheonv.defaultCondition = function(condition){
	var c = new Date();
