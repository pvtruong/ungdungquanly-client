var vanchuyenModule = new baseVoucher('vanchuyen','vanchuyen',[],'Vận chuyển',{
    ...
    onInput:function($scope,$options){
      ...
      $scope.phanbo = function(){
        ...
        var addSPMOI = function(item,callback){
            ...
            if(vanchuyenModule.defaultValues4Detail){
                for(var key in vanchuyenModule.defaultValues4Detail){
                    nrow[key] =vanchuyenModule.defaultValues4Detail[key];
                }
...
vanchuyenModule.defaultValues4Detail = {
	so_luong:0,
	ty_le_ck:0,
	gia_nt:0,gia:0,
	tien_nt:0,tien:0,
...
vanchuyenModule.defaultCondition4Search = {tu_ngay:new Date(),den_ngay:new Date(),so_ct:'',dien_giai:'',ma_kh:''};
vanchuyenModule.prepareCondition4Search = function($scope,vcondition){
	return {
